...
static PyObject* pyopencv_from(const Ptr<cv::KAZE>& r)
{
...
static bool pyopencv_to(PyObject* src, Ptr<cv::KAZE>& dst, const char* name="<unknown>")
{
    if( src == NULL || src == Py_None )
        return true;
